         ...
         <div class="row about__catalog">
            <div class="col-lg-6">
               <div class="about__catalog__credit">
                  ...
                  <a href="/oplata/" class="btn btn-outline-dark">Заявка на кредит</a>
               </div>
            </div>
            <div class="col-lg-6 pt-2 box-shadow-right">
               ...
               <div class="top__card__header">
                  ...
                  <div class="top__card__header__title">
                     ...
                     <div class="top__card__header__title__bottom">
                        ...
                        <?php endif; ?>
                        <div class="url"><a class="orange" href="<?php echo get_permalink(); ?>">Видео - характеристики</a></div>
                     </div>
                  </div>
               </div>
   ...
   <section class="single_page">
		<div class="container">
			<div class="row">
               ...
               <h4 class="h2__title liner">Стоимость монтажа</h4>
               <ul class="tech__list">
                  <li class="tech__list__item">
                     <span>модель 07</span>
                     <span>
               ...
               <p class="text-center">
                  <a class="btn btn-accent mt-2" href="/uslugi/ustanovka-split-sistem/">Подробнее</a>
            </p>
				</div>
         </div>
