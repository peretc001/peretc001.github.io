...
?>
    ...
    <div class="less__row">
        ...
        <div class="col-date<?php if (date('D') == 'Mon') { echo ' active'; } ?>" date-show="Mon">
            ...
            <?php for ($i = 1; $i <= 26; $i++ ) { ?>
                <div class="less__card<?php if($options['pn_col1_text'. $i] != '') { echo ' js-less-form'; } if($options['pn_col1_text'. $i] == '') { echo ' blank'; } if($options['pn_col'. $i .'_hidden'] == true) { echo ' hidden'; } ?>" data-time="<?php echo checkTime4($i); ?>" style='background: <?php if($options['pn_col1_bg'. $i] != "#000000") { echo $options['pn_col1_bg'. $i]; } ?>'>
		...
		<div class="col-date<?php if (date('D') == 'Tue') { echo ' active'; } ?>" date-show="Tue">
			...
			<?php for ($i = 1; $i <= 26; $i++ ) { ?>
                <div class="less__card<?php if($options['pn_col2_text'. $i] != '') { echo ' js-less-form'; } if($options['pn_col2_text'. $i] == '') { echo ' blank'; } if($options['pn_col'. $i .'_hidden'] == true) { echo ' hidden'; } ?>" data-time="<?php echo checkTime4($i); ?>" style='background: <?php if($options['pn_col2_bg'. $i] != "#000000") { echo $options['pn_col2_bg'. $i]; } ?>'>
		...
		<div class="col-date<?php if (date('D') == 'Wed') { echo ' active'; } ?>" date-show="Wed">
			...
			<?php for ($i = 1; $i <= 26; $i++ ) { ?>
                <div class="less__card<?php if($options['pn_col3_text'. $i] != '') { echo ' js-less-form'; } if($options['pn_col3_text'. $i] == '') { echo ' blank'; } if($options['pn_col'. $i .'_hidden'] == true) { echo ' hidden'; } ?>" data-time="<?php echo checkTime4($i); ?>" style='background: <?php if($options['pn_col3_bg'. $i] != "#000000") { echo $options['pn_col3_bg'. $i]; } ?>'>
		...
		<div class="col-date<?php if (date('D') == 'Thu') { echo ' active'; } ?>" date-show="Thu">
			...
			<?php for ($i = 1; $i <= 26; $i++ ) { ?>
                <div class="less__card<?php if($options['pn_col4_text'. $i] != '') { echo ' js-less-form'; } if($options['pn_col4_text'. $i] == '') { echo ' blank'; } if($options['pn_col'. $i .'_hidden'] == true) { echo ' hidden'; } ?>" data-time="<?php echo checkTime4($i); ?>" style='background: <?php if($options['pn_col4_bg'. $i] != "#000000") { echo $options['pn_col4_bg'. $i]; } ?>'>
		...
		<div class="col-date<?php if (date('D') == 'Fri') { echo ' active'; } ?>" date-show="Fri">
			...
			<?php for ($i = 1; $i <= 26; $i++ ) { ?>
                <div class="less__card<?php if($options['pn_col5_text'. $i] != '') { echo ' js-less-form'; } if($options['pn_col5_text'. $i] == '') { echo ' blank'; } if($options['pn_col'. $i .'_hidden'] == true) { echo ' hidden'; } ?>" data-time="<?php echo checkTime4($i); ?>" style='background: <?php if($options['pn_col5_bg'. $i] != "#000000") { echo $options['pn_col5_bg'. $i]; } ?>'>
		...
		<div class="col-date<?php if (date('D') == 'Sat') { echo ' active'; } ?>" date-show="Sat">
			...
			<?php for ($i = 1; $i <= 26; $i++ ) { ?>
                <div class="less__card<?php if($options['pn_col6_text'. $i] != '') { echo ' js-less-form'; } if($options['pn_col6_text'. $i] == '') { echo ' blank'; } if($options['pn_col'. $i .'_hidden'] == true) { echo ' hidden'; } ?>" data-time="<?php echo checkTime4($i); ?>" style='background: <?php if($options['pn_col6_bg'. $i] != "#000000") { echo $options['pn_col6_bg'. $i]; } ?>'>
		...
		<div class="col-date<?php if (date('D') == 'Sun') { echo ' active'; } ?>" date-show="Sun">
			...
			<?php for ($i = 1; $i <= 26; $i++ ) { ?>
                <div class="less__card<?php if($options['pn_col7_text'. $i] != '') { echo ' js-less-form'; } if($options['pn_col7_text'. $i] == '') { echo ' blank'; } if($options['pn_col'. $i .'_hidden'] == true) { echo ' hidden'; } ?>" data-time="<?php echo checkTime4($i); ?>" style='background: <?php if($options['pn_col7_bg'. $i] != "#000000") { echo $options['pn_col7_bg'. $i]; } ?>'>
