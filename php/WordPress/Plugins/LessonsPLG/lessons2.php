...
add_action('admin_menu', 'lessons_admin_page2');

// action function for above hook
function lessons_admin_page2() {
    add_menu_page('Расписание занятий2', 'Расписание занятий2', 10, __FILE__, 'lessons_page2', 'dashicons-calendar-alt', 47.6);
    register_setting( 'lessonsCustom2', 'lessons_option2' ); 
}
function lessons_page2() { 
...
?>
      ...
      <div class="lesson__row">
			...
			<?php 
				...
				<div class="lesson__card<?php if($options['pn_col'. $i .'_hidden'] == true) { echo ' hidden'; } ?>" data-time="<?php echo checkTime($i); ?>" style='background: <?php if($options['pn_col1_bg'. $i] != "#000000") { echo $options['pn_col1_bg'. $i]; } ?>'>
			 		<input type="color" name='lessons_option2[pn_col1_bg<?php echo $i; ?>]' value='<?php echo $options['pn_col1_bg'. $i]; ?>' placeholder="#fff">
            	<p><input type="text" name='lessons_option2[pn_col1_text<?php echo $i; ?>]' value='<?php echo $options['pn_col1_text'. $i]; ?>' <?php if($options['pn_col'. $i .'_hidden'] == true) { echo 'disabled'; } ?>></p>
			 	</div>
			<?php }  ?>
        	</div>
			...
			<div class="col-date<?php if (date('D') == 'Tue') { echo ' active'; } ?>" date-show="Tue">
				...
				<div class="lesson__card<?php if($options['pn_col'. $i .'_hidden'] == true) { echo ' hidden'; } ?>" data-time="<?php echo checkTime($i); ?>" style='background: <?php if($options['pn_col2_bg'. $i] != "#000000") { echo $options['pn_col2_bg'. $i]; } ?>'>
					<input type="color" name='lessons_option2[pn_col2_bg<?php echo $i; ?>]' value='<?php echo $options['pn_col2_bg'. $i]; ?>' placeholder="#fff">
					<p><input type="text" name='lessons_option2[pn_col2_text<?php echo $i; ?>]' value='<?php echo $options['pn_col2_text'. $i]; ?>' <?php if($options['pn_col'. $i .'_hidden'] == true) { echo 'disabled'; } ?>></p>
				</div>
			<?php }  ?>
			</div>
			...
			<div class="col-date<?php if (date('D') == 'Wed') { echo ' active'; } ?>" date-show="Wed">
				...
				<div class="lesson__card<?php if($options['pn_col'. $i .'_hidden'] == true) { echo ' hidden'; } ?>" data-time="<?php echo checkTime($i); ?>" style='background: <?php if($options['pn_col3_bg'. $i] != "#000000") { echo $options['pn_col3_bg'. $i]; } ?>'>
					<input type="color" name='lessons_option2[pn_col3_bg<?php echo $i; ?>]' value='<?php echo $options['pn_col3_bg'. $i]; ?>' placeholder="#fff">
					<p><input type="text" name='lessons_option2[pn_col3_text<?php echo $i; ?>]' value='<?php echo $options['pn_col3_text'. $i]; ?>' <?php if($options['pn_col'. $i .'_hidden'] == true) { echo 'disabled'; } ?>></p>
				</div>
			<?php }  ?>
			</div>
			...
			<div class="col-date<?php if (date('D') == 'Thu') { echo ' active'; } ?>" date-show="Thu">
				...
				<div class="lesson__card<?php if($options['pn_col'. $i .'_hidden'] == true) { echo ' hidden'; } ?>" data-time="<?php echo checkTime($i); ?>" style='background: <?php if($options['pn_col4_bg'. $i] != "#000000") { echo $options['pn_col4_bg'. $i]; } ?>'>
					<input type="color" name='lessons_option2[pn_col4_bg<?php echo $i; ?>]' value='<?php echo $options['pn_col4_bg'. $i]; ?>' placeholder="#fff">
					<p><input type="text" name='lessons_option2[pn_col4_text<?php echo $i; ?>]' value='<?php echo $options['pn_col4_text'. $i]; ?>' <?php if($options['pn_col'. $i .'_hidden'] == true) { echo 'disabled'; } ?>></p>
				</div>
			<?php }  ?>
			</div>
			...
			<div class="col-date<?php if (date('D') == 'Fri') { echo ' active'; } ?>" date-show="Fri">
				...
				<div class="lesson__card<?php if($options['pn_col'. $i .'_hidden'] == true) { echo ' hidden'; } ?>" data-time="<?php echo checkTime($i); ?>" style='background: <?php if($options['pn_col5_bg'. $i] != "#000000") { echo $options['pn_col5_bg'. $i]; } ?>'>
					<input type="color" name='lessons_option2[pn_col5_bg<?php echo $i; ?>]' value='<?php echo $options['pn_col5_bg'. $i]; ?>' placeholder="#fff">
					<p><input type="text" name='lessons_option2[pn_col5_text<?php echo $i; ?>]' value='<?php echo $options['pn_col5_text'. $i]; ?>' <?php if($options['pn_col'. $i .'_hidden'] == true) { echo 'disabled'; } ?>></p>
				</div>
			<?php }  ?>
			</div>
			...
			<div class="col-date<?php if (date('D') == 'Sat') { echo ' active'; } ?>" date-show="Sat">
				...
				<div class="lesson__card<?php if($options['pn_col'. $i .'_hidden'] == true) { echo ' hidden'; } ?>" data-time="<?php echo checkTime($i); ?>" style='background: <?php if($options['pn_col6_bg'. $i] != "#000000") { echo $options['pn_col6_bg'. $i]; } ?>'>
					<input type="color" name='lessons_option2[pn_col6_bg<?php echo $i; ?>]' value='<?php echo $options['pn_col6_bg'. $i]; ?>' placeholder="#fff">
					<p><input type="text" name='lessons_option2[pn_col6_text<?php echo $i; ?>]' value='<?php echo $options['pn_col6_text'. $i]; ?>' <?php if($options['pn_col'. $i .'_hidden'] == true) { echo 'disabled'; } ?>></p>
				</div>
			<?php }  ?>
			</div>
			...
			<div class="col-date<?php if (date('D') == 'Sun') { echo ' active'; } ?>" date-show="Sun">
				...
				<div class="lesson__card<?php if($options['pn_col'. $i .'_hidden'] == true) { echo ' hidden'; } ?>" data-time="<?php echo checkTime($i); ?>" style='background: <?php if($options['pn_col7_bg'. $i] != "#000000") { echo $options['pn_col7_bg'. $i]; } ?>'>
					<input type="color" name='lessons_option2[pn_col7_bg<?php echo $i; ?>]' value='<?php echo $options['pn_col7_bg'. $i]; ?>' placeholder="#fff">
					<p><input type="text" name='lessons_option2[pn_col7_text<?php echo $i; ?>]' value='<?php echo $options['pn_col7_text'. $i]; ?>' <?php if($options['pn_col'. $i .'_hidden'] == true) { echo 'disabled'; } ?>></p>
				</div>
			<?php }  ?>
			</div>
			...
			<div class="col-date">
				...
				<div class="lesson__card check">
					<input type="checkbox" name='lessons_option2[pn_col<?php echo $i; ?>_hidden]' <?php if($options['pn_col'. $i .'_hidden'] == true) { echo 'checked'; } ?>>
				</div>
			<?php }  ?>
			</div>
  ...
  <script src="<?php echo $url .'script.js'; ?>"></script>
	   ...
	   <?php
	        settings_fields( 'lessonsCustom2' );
	        do_settings_sections( 'lessonsCustom2' );
