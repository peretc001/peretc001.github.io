...
function krasovsky23_scripts() {
	...
	//wp_enqueue_script( 'krasovsky23-popper', 'https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js', array(), '1', true );
	//wp_enqueue_script( 'krasovsky23-bootstrap', 'https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js', array(), '1', true );

	wp_enqueue_script( 'krasovsky23-js', get_template_directory_uri() . '/js/script.js', array(), time(), true );
}
add_action( 'wp_enqueue_scripts', 'krasovsky23_scripts' );
