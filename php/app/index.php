        ...
        <div class="form-room">
          <form method="post" class="calc-room---form calc__ajax__form--first">
            ...
            <div class="calc-room">
                ...
                <input type="range" name="width" id="rangeWidthRoom" class="rangeWidthRoom" value="0.96" min="0.96" max="29.76" step="0.96">
                ...
                <input type="range" name="height" id="rangeHeightRoom" class="rangeHeightRoom" value="0.96" min="0.96" max="49.92" step="0.96">
            ...
            <div class="options-third-block-big-photo-block">
              <ul class="options-third-block-big-photo-block__list">
                <li class="options-third-block-big-photo-block__item">
                  ...
                  <span class="parval" id="size-cab-room">960 х 960 мм</span>
                </li>
                <li class="options-third-block-big-photo-block__item">
        ...
        <div class="form-street">
          ...
          <form method="post" class="calc-room---form calc__ajax__form--second">
            ...
            <div class="calc-room">
              ...
              <input type="range" name="width" id="rangeWidthRoom" class="rangeWidthRoomStreet" value="0.96" min="0.96" max="29.76" step="0.96">
              ...
              <input type="range" name="height" id="rangeHeightRoom" class="rangeHeightRoomStreet" value="0.96" min="0.96" max="49.92" step="0.96">
            ...
            <div class="options-third-block-big-photo-block">
              <ul class="options-third-block-big-photo-block__list">
                <li class="options-second-block-big-photo-block__item">
                  <span class="parname">Размер кабинета</span>
                  <span class="dotted"></span>
                  <span class="parval" id="size-cab-street">960 х 960 мм</span>
                </li>
                <li class="options-third-block-big-photo-block__item">
                  <span class="parname">Доступ для обслуживания экрана</span>
                  <span class="dotted"></span>
            ...
            <div class="options-third-block-big-photo-block">
              <ul class="options-third-block-big-photo-block__list">
                <li class="options-second-block-big-photo-block__item">
                  <span class="parname">Размер кабинета</span>
                  <span class="dotted"></span>
                  <span class="parval" id="size-cab-media">1000 x 1000 мм</span>
                </li>
                <li class="options-third-block-big-photo-block__item">
                  <span class="parname">Доступ для обслуживания экрана</span>
                  <span class="dotted"></span>
