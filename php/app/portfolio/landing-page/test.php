...
$db = new JsonDB( $_SERVER['DOCUMENT_ROOT'] . '/portfolio/' );
	$result = $db->select('portfolio', 'id', 11);
...
<body class="is-page">
	...
	<div class="breadcrumbs">
		<div class="container">
			<a href="/">Главная</a> / <a href="/portfolio/">Портфолио</a> / <a href="/portfolio/landing-page/"><?php echo $themes; ?></a> / <?php echo $title; ?>
		</div>
	</div>
	<section class="work">
		<div class="container">
			...
			<img class="work-img" src="/assets/img/portfolio/<?php echo $img; ?>.jpg" alt="<?php echo $title; ?>" class="wow fadeInUp">
		</div>
	</section>
