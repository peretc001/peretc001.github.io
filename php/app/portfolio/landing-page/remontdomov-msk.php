...
<body class="is-page">
	...
	<section class="work">
		<div class="container">
			...
			<img class="work-img" src="/img/portfolio/remontdomov-msk-admin.jpg" alt="" class="wow fadeInUp">

			<div class="introHolder wow fadeInUp">
				<h2 class="liner">Скрин всего сайта</h2>
			</div>
			<img class="work-img" src="/img/portfolio/remontdomov-msk-index.jpg" alt="" class="wow fadeInUp">
		</div>
	</section>
