...
<?php
	...
	$db = new JsonDB( $_SERVER['DOCUMENT_ROOT'] . '/portfolio/' );
		$result = $db->select('portfolio', 'portfolio', 'landing-page');
	...
	<section class="portfolio" id="portfolio">
		<div class="container">
			...
			<div class="row text-center">
				<blockquote>
					<p>Разработка, дизайн, верстка и программирование Landing page под ключ на базе Wordpress</p>
					...
					<p>В итоге вы получите одностраничный сайт с возможностью редактирования и добавления информации через админ панель без знания языков программирования.</p>
				</blockquote>
			</div>
			<div class="row text-center">
