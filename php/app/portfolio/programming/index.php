...
<?php
	...
	$db = new JsonDB( $_SERVER['DOCUMENT_ROOT'] . '/portfolio/' );
		$result = $db->select('portfolio', 'portfolio', 'programming');
	...
	<section class="portfolio" id="portfolio">
		<div class="container">
			...
			<div class="row text-center">
				<blockquote>
					<p>Разработка плагинов и сайтов на wordpress</p>
					...
					<p>В итоге вы получите готовый продукт, который легко можно редактировать через админ панель wordpress</p>
				</blockquote>
			</div>
			<div class="row text-center">
