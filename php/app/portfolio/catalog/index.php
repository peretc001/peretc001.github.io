...
<?php
	...
	$db = new JsonDB( $_SERVER['DOCUMENT_ROOT'] . '/portfolio/' );
		$result = $db->select('portfolio', 'portfolio', 'catalog');
	...
	<section class="portfolio" id="portfolio">
		<div class="container">
			...
			<div class="row text-center">
				<blockquote>
					<p>Разработка, дизайн, верстка и программирование сайтов-каталогов под ключ на базе Wordpress</p>
					<p>По согласованию могу спарсить товары и залить вам в админку Wordpress</p>
					...
					<p>В итоге вы получите сайт-каталог с возможностью редактирования и добавления информации через админ панель без знания языков программирования.</p>
				</blockquote>
			</div>
			<div class="row text-center">
