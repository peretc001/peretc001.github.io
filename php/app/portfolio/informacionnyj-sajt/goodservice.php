...
$db = new JsonDB( $_SERVER['DOCUMENT_ROOT'] . '/portfolio/' );
	$result = $db->select('portfolio', 'id', 5);
...
<body class="is-page">
	...
	<div class="breadcrumbs">
		<div class="container">
			<a href="/">Главная</a> / <a href="/portfolio/">Портфолио</a> / <a href="/portfolio/informacionnyj-sajt/"><?php echo $themes; ?></a> / <?php echo $title; ?>
		</div>
	</div>
	<section class="work">
		<div class="container">
			...
			<div class="introHolder wow fadeInUp">
				<h2 class="liner">Разработка логотипа</h2>
			</div>
			<img class="work-img" src="/assets/img/portfolio/<?php echo $img; ?>-logo.svg" alt="<?php echo $title; ?>" class="wow fadeInUp">
			<div class="introHolder wow fadeInUp">
				<h2 class="liner">Скрин сайта</h2>
			</div>
