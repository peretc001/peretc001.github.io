window.addEventListener("DOMContentLoaded", function() {
    ...
    let form2 = document.querySelectorAll('.addemail__form');
    form2.forEach(item => {
    let formBtn2 = item.querySelector('.callback__form__button');
    let checkBtn2 = item.querySelector('.circle-loader');
    let complete2 = item.querySelector('.checkmark');

    formBtn2.disabled = true;
    checkBtn2.addEventListener('click', () => {
        checkBtn2.classList.add('load-complete');
        checkBtn2.style.cursor = 'auto';
        complete2.style.display = 'block';
    
        item.action = '../inc/form/addemail.php';
        var input = document.createElement("input");
        input.setAttribute("type", "hidden");
        input.setAttribute("name", "human");
        input.setAttribute("value", "human");
