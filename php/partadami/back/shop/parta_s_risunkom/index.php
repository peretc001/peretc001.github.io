...
<body>
	...
	<div id="nav_menuid">
		<div class="row">
			<a href="/">Главная</a> <i class="fa fa-angle-right" aria-hidden="true"></i> <a href="/shop/">Каталог товаров</a> <i class="fa fa-angle-right" aria-hidden="true"></i> Парты «ДЭМИ» c рисунком
		</div>
	</div>
	<div id="product">
		...
		<div class="row">
			...
			<div class="one-third column filter">
				...
				<ul class="model">
					<li><?php 	if ($art == '' or $art == '14') { echo '<i class="fa fa-check-square-o" aria-hidden="true"></i> <b>СУТ.14Р</b>'; } else { ?><a href="/shop/parta_s_risunkom/index.php?art=14<?php 	if ($package == 'parta_0_stul') { echo "&package=parta_0_stul"; } elseif ($package == 'parta_1_stul') { echo "&package=parta_1_stul"; } elseif ($package == 'parta_2_stul') { echo "&package=parta_2_stul"; }  ?>"><i class="fa fa-square-o" aria-hidden="true"></i> СУТ.14Р</a><?php } ?><br><span><i class="fa fa-expand" aria-hidden="true"></i> 75х55 см</span></li>
					<li><?php 	if ($art == '17') { echo '<i class="fa fa-check-square-o" aria-hidden="true"></i> <b>СУТ.17Р</b>'; } else { ?><a href="/shop/parta_s_risunkom/index.php?art=17<?php 	if ($package == 'parta_0_stul') { echo "&package=parta_0_stul"; } elseif ($package == 'parta_1_stul') { echo "&package=parta_1_stul"; } elseif ($package == 'parta_2_stul') { echo "&package=parta_2_stul"; }  ?>"><i class="fa fa-square-o" aria-hidden="true"></i> СУТ.17Р</a><?php } ?><br><span><i class="fa fa-expand" aria-hidden="true"></i> 120х55 см (две столешницы)</span></li>
				</ul>
			</div>
