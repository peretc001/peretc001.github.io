<?php session_start(); 
	...
	$art = htmlspecialchars(trim($_GET['art']));			if ($art == '') {$art = '28'; }
				...
				?><div class="row product-list-all">
					...
					<div class="two-thirds column  product-list">
						...
						<ul class="color">
							...
							<?php } elseif ($art == '14') { ?>
								<li><a href="/shop/<?php echo $row['category']; ?>/cyt<?php echo $row['art']; ?><?php if ($package == 'parta_0_stul') { echo "/bez_stula"; }?>/parta_cyt<?php echo $row['url']; ?><?php if ($package == '' or $package == 'parta_1_stul') { echo "_so_stulom_cyt01-01"; } ?>.php?color=kbeige"><i class="fa fa-square beige" aria-hidden="true"></i></a></li>
								<li><a href="/shop/<?php echo $row['category']; ?>/cyt<?php echo $row['art']; ?><?php if ($package == 'parta_0_stul') { echo "/bez_stula"; }?>/parta_cyt<?php echo $row['url']; ?><?php if ($package == '' or $package == 'parta_1_stul') { echo "_so_stulom_cyt01-01"; } ?>.php?color=grey"><i class="fa fa-square grey" aria-hidden="true"></i></a></li>
						...
						<div class="product-price" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
							<ul>
								<li><b><?php $lpr = $row['price']; echo '<span itemprop="price">'. round($lpr, 0); ?></span> <small><meta itemprop="priceCurrency" content="RUB" />РУБ.</small></b></li>
