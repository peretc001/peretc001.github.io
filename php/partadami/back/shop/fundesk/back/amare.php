				...
				<tr>
					...
					<td>
						<ul>
							...
							<li><em>Производитель </em><span><?php echo $row['p16']; ?></span></li><li class="none">&nbsp;</li>
	...
	<div id="page">
		...
		<div id="ca-container" class="ca-container">
				<div class="ca-wrapper">
					<?php 	$i=1;
$dop = mysql_query("SELECT * FROM `accessories` WHERE id = '118' or id = '119' or id = '120' or id = '121' or id = '122' or id = '123' or id = '124'  order by id asc ");
