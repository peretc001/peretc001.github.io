$(function(){
	...
	$('.clear_input_phone').on('click', function(e){	
		$('#company_phone').val('')
		$('.clear_input_phone').hide();
	});

	$('.clear_input_email').on('click', function(e){	
		$('#company_email').val('')
		$('.clear_input_email').hide();
	});
	...
	$('.clear_input_date').on('click', function(e){	
		$('#date_format').val('')
		$('.clear_input_date').hide();
		flag = 2;
	});

	$('.clear_input_time').on('click', function(e){	
		$('#form-time').val('')
		$('.clear_input_time').hide();
		flag = 2;
	});
	...
	if(document.querySelector('body').classList.contains('is-company')) {
