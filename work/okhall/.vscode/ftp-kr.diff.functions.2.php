...
function okHall_page() { ?>
    ...
    <style type="text/css">
    	...
    	.okhall {padding:0 0 10px 0;background-color:#ffae04;}
		.okhall .modal-header {border: none; margin:0 auto; width: 100%; text-align: center;}
		.okhall .modal-header .modal_okhall {width: 100%;text-align: center;}
		.okhall .modal-header h2 {color:#111;font-size:30px; margin: 0;}
		.okhall .modal-header h2 span {color:#fff;font-size:30px; margin: 0;}
		.okhall .modal-header p {color:#111;font-size:18px;margin: 0;}
		.okhall .modal-header .close {position: absolute; right: 20px; top: 20px;}
		.okhall .modal-body {padding: 30px 10%;}
		.okhall .modal-body .form-control {padding:5px;font-size:20px; text-align:center;background:#ffae04;color:#fff;border:.5px solid #e49e0a;font-weight: bold;}
		.okhall .modal-body .btn.btn-primary {margin: 0 auto;}
		.okhall .modal-body ::-webkit-input-placeholder{font-size:1.2rem;color:#fff;}
		.okhall .modal-body ::-moz-placeholder{font-size:2.2rem} 
		.okhall .modal-body :-moz-placeholder{font-size:2.2rem} 
		.okhall .modal-body :-ms-input-placeholder{font-size:2.2rem}
    </style>
				...
				<div class="col-10 offset-1 col-lg-6 offset-lg-3 text-center">
					...
					<div class="modal-content okhall">
				    	<div class="modal-header">
				    		<div class="modal_okhall">
					    		<h2><input type='text' class="form-control transp white text-center"  name='okHall_settings[photos__modal__h2__intro]' value='<?php echo $options['photos__modal__h2__intro']; ?>'></h2>
								<p><input type='text' class="form-control transp white text-center"  name='okHall_settings[photos__modal__p__intro]' value='<?php echo $options['photos__modal__p__intro']; ?>'></p>
							</div>
						...
						<div class="modal-body">
								...
								<div class="form-group">
									<input type="email" name="email" class="form-control" required="true" placeholder="Email *" disabled/>
								</div>
								<button type="sumbit" class="btn btn-success" disabled>Отправить</button>
