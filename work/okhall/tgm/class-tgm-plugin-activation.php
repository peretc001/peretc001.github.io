		...
		public function init() {
			...
			$this->strings = array(
				...
				'notice_can_install_required'     => _n_noop(
					...
					'<br><span style="font-size:20px;color:red">&#9873;</span> Требуется установка плагина: %1$s.',
					'<br><span style="font-size:20px;color:red">&#9873;</span> Требуется установка плагинов: %1$s.',
					'tgmpa'
				),
