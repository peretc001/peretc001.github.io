...
<head> 
	<title>Автомобильная накидка на сиденья из льна <?php echo $row['color']; ?> - АВТОНАКИДКИ.НЕТ</title> 
...
<body>
	...
	<div class="refresh">
		<div class="menuid" itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			...
			<a href="/catalog/<?php echo $row['category']; ?>/" itemprop="url"><span itemprop="title">Накидки из льна</span></a> / Автомобильная накидка на сиденья из льна <?php echo $row['color']; ?>
		</div>
		<div class="product_page">
			
			<div class="introHolder">
				<h1>Накидка на сиденья из льна <?php echo $row['color']; ?></h1>
			</div>
			<div class="row">
				...
				<div class="one-half column page_right">
					<ul class="color">
						<li><a href="/catalog/<?php echo $row['category']; ?>/nakidka_dly_avto_iz_lna_ceraya/"><i class="fa <?php if ($id == '401') { echo 'fa-check-circle'; } else { echo 'fa-circle'; }?> grey" aria-hidden="true" title="Серый"></i></a></li>
					</ul>
					<ul class="tech">
