(function($) {
    jQuery.fn.drop_uploader = function(options) {
        ...
        this.each(function(i, val) {
            ...
            $(v).before('<div class="text_wrapper"><a href="#" class="' + options.browse_css_class + ' ' + options.browse_css_selector + '">' + options.browse_text + '</a></span></div>');
                    ...
                    if(response.success) {
                        ...
                        $('#' + uploader_id + ' #selected_file_' + i + ' i.action-delete').on("click", function(event) {
                            ...
                            $.ajax({
                                ...
                                added_files--;
                            //Показываем кнопку ДОБАВИТЬ ФАЙЛ
                            $('#' + uploader_id + ' a').delay(1500).fadeIn("slow");
                            });
                        });
                    } else {
