...
$html.='<html><head><title>Счет на оплату</title>  <meta http-equiv="Content-Type" content="text/html; charset=utf-8" /></head>
        ...
        <table class="top">
			<tr>
				...
				<td>350049, г. Краснодар, ул. Тургенева, 56<br>
				Телефон: (861) 242-81-05<br>
		...
		<table class="recvizit">
			<tr>
				...
				<td colspan="2" class="top_right">ООО "КрасГрупп"</td>
			</tr>
			<tr>
				<td class="left">ИНН</td>
				<td class="left1">2308182251</td>
				<td class="right">КПП</td>
				<td class="right1">230801001</td>
			</tr>
			<tr>
				<td class="left">Р/с</td>
				<td class="left1">40702810647000007135</td>
	...
	$html.='<table class="theme" style="border:0;">
		...
		<table class="stamp">
			<tr>
				...
				<td class="line"><img src="stamp.png"></td>
