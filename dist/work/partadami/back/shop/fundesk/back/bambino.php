				...
				<tr>
					<td>
						<ul>
							...
							<li><em>Подвесная тумба </em><span><?php echo $row['p11']; ?></span></li>
	...
	<div id="page">
		...
		<div id="ca-container" class="ca-container">
				<div class="ca-wrapper">
					<?php 	$i=1;
$dop = mysql_query("SELECT * FROM `accessories` WHERE id = '118' or id = '119' or id = '120' or id = '121' or id = '123' or id = '124' or id = '125' order by id asc ");
