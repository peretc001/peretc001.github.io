...
function my_scripts() {
	wp_enqueue_style( 'fonts', 'https://fonts.googleapis.com/css?family=Open+Sans:400,700', false, null, all);
	wp_enqueue_style( 'bootstrap', 'https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css', false, null, all);
	...
	wp_enqueue_style( 'owl', get_stylesheet_directory_uri() . '/js/owlCarousel/css/owl.carousel.min.css', false, null, all );
	...
	wp_register_script( 'poper', 'https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js', 'jquery', null, true);
	wp_register_script( 'bootstrap_js', 'https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js', 'jquery', null, true);
	wp_register_script( 'owl', get_stylesheet_directory_uri() . '/js/owlCarousel/owl.carousel.min.js', 'jquery', null, true);
