                ...
                elem.addEventListener('click', (event) => {
                    ...
                    setTimeout(() => {
                        ...
                        if ( event.target.dataset.target == 'login' ) {
                            modal.querySelector('[data-modal="'+ event.target.dataset.target +'"] form').append(hiddenInput)
                            hiddenInput.focus()
                            setTimeout(() => {
                                modal.querySelector('.phone-mask').focus()    
                                modal.querySelector('[data-modal="'+ event.target.dataset.target +'"] form').removeChild(hiddenInput)
                            }, 300);
                        }
                    }, 600);
