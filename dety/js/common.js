...
if ( document.querySelector('nav') ) {
    ...
    closeMobileMenu = () => {
        ...
        if ( catalog.querySelector('.nav-catalog__submenu.in') ) {
            let parrent = localStorage.getItem('menu') || 'catalog'
            const id = catalog.querySelector('.nav-catalog__parent.fade.active').getAttribute('data-parent')
            current = catalog.querySelector('[data-submenu="'+parrent+'"]')
            currentParrent = current.querySelector('[data-parent="'+ id +'"]')
