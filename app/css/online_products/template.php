...
<div class="col-12 products__list__sort">
			<p><?php 
				...
				?></p>
			<p class="products__list__sort--block">
				Сортировать по
				<span class="products__list__sort--block-item">
					<a <?if ($_GET["sort"] == "property_AVAILABILITY"):?> class="active" <?endif;?> href="<?=$arResult["SECTION_PAGE_URL"]?>?sort=property_AVAILABILITY&method=asc">Наличию</a> 
    				<a <?if ($_GET["sort"] == "name"):?> class="active" <?endif;?> href="<?=$arResult["SECTION_PAGE_URL"]?>?sort=name&method=asc">Алфавиту</a> 
				</span>
			</p>
		</div>
			<!-- items-container -->
